  ...
  <div class="app">
    <header>
      <div class="header-content">
        ...
        <p class="subtitle">Discover unusual and fun holidays throughout
   the year!</p>
      </div>
    </header>
  ...
  class:active={currentPage === '/'}>
        ...
        <a href="#/random" on:click|preventDefault={() =>
  navigateTo('/random')} class:active={currentPage === '/random'}>
          <span class="icon">🎲</span>
          <span class="label">Randomizer</span>
        </a>
        <a href="#/quiz" on:click|preventDefault={() =>
  navigateTo('/quiz')} class:active={currentPage === '/quiz'}>
          <span class="icon">🎮</span>
          <span class="label">Quiz</span>
        </a>
        <a href="#/create" on:click|preventDefault={() =>
  navigateTo('/create')} class:active={currentPage === '/create'}>
          <span class="icon">✏</span>
    ...
    <footer>
      ...
      <p class="tagline">Because every day deserves to be
  celebrated!</p>
    </footer>
  </div>
